...
from backend.get_data_db import get_color_data
...
class TopBar(ft.Container):
    def __init__(self, main_instance):
        ...
        self.data = get_color_data()
        self.color_R = self.data[0]/255
        self.color_G = self.data[1]/255
        self.color_B = self.data[2]/255
    ...
    def convertTo_pdf(self, e):
        if e.control.text == "Export PDF":
            ...
            self.doc_created_alert("PDF", file_name)
            for step, value in self.main_instance.steps_data.items():
                ...
                container_height = 50  
                pdf.setFillColorRGB(self.color_R, self.color_G, self.color_B)  
